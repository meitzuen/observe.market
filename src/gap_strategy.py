...
def run_strategy(date_str=None):
    ...
    print(f"Comparing today ({today_date}) with previous date ({prev_date})")
    ...
    print(f"Found {len(results)} stocks. Results saved to {output_path}")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run Gap Jump strategy.")
    parser.add_argument(
        "--date_str",
        type=str,
